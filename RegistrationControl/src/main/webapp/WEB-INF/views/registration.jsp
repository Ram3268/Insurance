	...
	<div class="container">
		<form id="regform" action="registration" method="post">
			...
			<label for="psw">PASSWORD:</label> <input type="password"
				...
				required> <br> RETYPE:<input type="password"
				id="retype" name="retype" required><br> <input
				type="submit" value="Signup" onclick="myFunction()"> <input
				type="button" value="Login" onclick="window.location='login'">
		</form>
